 ...
 namespace MST
{
     ...
     int kruskalsMinimumSpanningTree(int numberOfVertices, int adjacencyMatrix[][10])
     {
         ...
         // Sort edges by weight in ascending order "built in function iside algorithm to sort by ascending order
         ...
         for (Edge& currentEdge : allEdges)
         {
             ...
             cout << "Root(" << currentEdge.source << ")= " << root1 << " , Root(" << currentEdge.destination << ")= " << root2 << " ";
